...
/**
 * Servlet implementation class AllowActionsServlet
 */
@WebServlet("/AllowActionsServlet")
public class AllowActionsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AllowActionsServlet() {
        super();
